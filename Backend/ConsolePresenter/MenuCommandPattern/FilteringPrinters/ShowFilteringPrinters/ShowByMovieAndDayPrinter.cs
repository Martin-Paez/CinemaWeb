...
{
    public class ShowsByMovieAndDayPrinter : FilteringPrinter<ShowResponse>
    {
        private IGetAllMoviesService _getMovies;
        private IGetShowByService _getShows;

        public ShowsByMovieAndDayPrinter(
            IEnhacedConsole cmd,
        ...
        protected override IList<ShowResponse> GetFiltereds()
        {
            ...
            return null!;//_getShows.GetShowsByMovieAndDay(id, _cmd.ReadDate());
        }
    }
}
